...
int main(void) {
	...
	x86_64_PushWRM64(&c, 125, R12, R12, Scale4x);
	TestSlice(0x66, 0x43, 0xFF, 0x74, 0xA4, 0x7D);
	...
	x86_64_PushWRM32(&c, -69420, EBX, ESI, Scale8x);
	TestSlice(0x67, 0x66, 0xFF, 0xB4, 0xF3, 0xD4, 0xF0, 0xFE, 0xFF);
